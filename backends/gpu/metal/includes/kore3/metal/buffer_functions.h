#ifndef KORE_METAL_BUFFER_FUNCTIONS_HEADER
#define KORE_METAL_BUFFER_FUNCTIONS_HEADER
...
void kore_metal_buffer_upload(struct kore_gpu_device *device, const void *data, uint64_t size, uint32_t usage_flags, kore_gpu_buffer *buffer);
